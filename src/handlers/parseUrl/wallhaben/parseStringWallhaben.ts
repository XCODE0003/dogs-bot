...
export const parseStringWallhaben = async (url: string, ctx: Context): Promise<ParseString | undefined> => {
    ...
    try {
        ...
        try {
            const response = await axios.get("https://www.anibis.ch/fr/vi/vaud/vehicules/motos/motos-cbr/50668940", {
                "headers": {
                    "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                    "accept-language": "ru,ru-RU;q=0.9,en-US;q=0.8,en;q=0.7,ja;q=0.6",
                    "cache-control": "max-age=0",
            ...
            body = response.data
            await fs.writeFileSync('./testAnibich.html', body, 'utf-8')
            console.log(body)
