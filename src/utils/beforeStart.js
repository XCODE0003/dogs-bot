...
var notificationHandlers_1 = require("@/notificationHandlers");
var middlewares_1 = require("@/middlewares");
var bot_1 = require("./bot");
var database_1 = require("@/database");
var logger_1 = require("@/utils/logger");
var setupSession_1 = require("./setupSession");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, database_1.dataSourceDatabase
                            .initialize()
                            .then(function () {
                            logger_1.log.debug('Successfully connected to database');
                        })["catch"](function (e) { return logger_1.log.fatal('Error while connect to database ', e); })];
