...
async function preCreateAd(ctx, parse, match) {
    ...
    const domen = await (0, getDomen_1.getDomen)(ctx.user, 'anibis');
    if (!domen)
...
exports.scene = new grammy_scenes_1.Scene('setDeliveryAmountAnibis');
exports.scene.always().callbackQuery(/skip setDeliveryAmountAnibis/, async (ctx) => {
    // @ts-ignore
